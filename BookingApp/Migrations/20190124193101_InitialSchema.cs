        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinTime = table.Column<int>(nullable: true, defaultValue: 1),
                    MaxTime = table.Column<int>(nullable: true, defaultValue: 1440),
                    StepTime = table.Column<int>(nullable: true, defaultValue: 1),
                    ServiceTime = table.Column<int>(nullable: true, defaultValue: 0),
                    ReuseTimeout = table.Column<int>(nullable: true, defaultValue: 0),
                    PreOrderTimeLimit = table.Column<int>(nullable: true, defaultValue: 1440),
                    ...
                    UpdatedUserId = table.Column<string>(maxLength: 450, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rules", x => x.RuleId);
                    table.ForeignKey(
                        name: "FK_Rules_AspNetUsers_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rules_AspNetUsers_UpdatedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TreeGroups_AspNetUsers_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TreeGroups_AspNetUsers_UpdatedUserId",
                        column: x => x.UpdatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resources_AspNetUsers_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Resources_AspNetUsers_UpdatedUserId",
                        column: x => x.UpdatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_AspNetUsers_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_AspNetUsers_UpdatedUserId",
                        column: x => x.UpdatedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_UpdatedUserId",
                table: "Bookings",
                column: "UpdatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Resources_CreatedUserId",
                table: "Resources",
                column: "CreatedUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resources_UpdatedUserId",
                table: "Resources",
                column: "UpdatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Rules_CreatedUserId",
                table: "Rules",
                column: "CreatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Rules_UpdatedUserId",
                table: "Rules",
                column: "UpdatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TreeGroups_CreatedUserId",
                table: "TreeGroups",
                column: "CreatedUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreeGroups_UpdatedUserId",
                table: "TreeGroups",
                column: "UpdatedUserId");
        }
